...
*  PURPOSE:
*
*   This program implements a simple test program for talking to a bioloid
*   servo. It assumes that the bioloiid-rs program is loaded on the robostix.
*
*   Press a b or c to command the servo to goto left, middle, or center.
*
*   The servo must have an ID of 5
*
*****************************************************************************/
...
void *ReaderThread( void *param )
{
    while ( 1 )
    {
        ...
        printf( "0x%02x ", (unsigned)( ch & 0xff ) );
    }
