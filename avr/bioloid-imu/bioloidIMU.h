...
#define ADC_FORWARDS_ACCEL_CHANNEL 1
#define ADC_SIDEWAYS_ACCEL_CHANNEL 0
#define ADC_VERTICAL_ACCEL_CHANNEL 2

#define ADC_PITCH_RATE_CHANNEL 5
#define ADC_ROLL_RATE_CHANNEL 4
