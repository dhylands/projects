...
static inline const char* as_str(Command cmd) {
    switch (cmd) {
        case Command::PING:
            return "PING";
        case Command::READ:
...
static inline uint16_t as_uint8_t(Error err) {
...
static inline const char* as_str(Error err) {
    switch (err) {
        case Error::RESERVED:
            return "RESERVED";
        case Error::INSTRUCTION:
            return "INSTRUCTION";
        case Error::OVERLOAD:
            return "OVERLOAD";
        case Error::CHECKSUM:
        ...
        case Error::OVERHEATING:
            return "OVERHEATING";
        case Error::ANGLE_LIMIT:
            return "ANGLE_LIMIT";
        case Error::INPUT_VOLTAGE:
